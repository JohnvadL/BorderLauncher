...
import com.border.launcher.provider.RestoreDbTask;
import com.border.launcher.util.ManagedProfileHeuristic;
import com.border.launcher.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    public void reloadLauncherIfExternal() {
        Log.e("LauncherProvider", "ReloadLauncherIfExternal" );
