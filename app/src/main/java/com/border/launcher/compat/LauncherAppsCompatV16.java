...
package com.border.launcher.compat;
...
public class LauncherAppsCompatV16 extends LauncherAppsCompat {
    ...
    public List<OnAppsChangedCallbackCompat> mCallbacks
    ...
    @Thunk public synchronized List<OnAppsChangedCallbackCompat> getCallbacks() {
