...
import com.border.launcherfree.LauncherSettings.Favorites;
import com.border.launcherfree.accessibility.LauncherAccessibilityDelegate;
import com.border.launcherfree.allapps.AllAppsContainerView;
import com.border.launcherfree.allapps.AllAppsTransitionController;
import com.border.launcherfree.allapps.DefaultAppSearchController;
import com.border.launcherfree.allapps.PredictiveAppsProvider;
import com.border.launcherfree.compat.AppWidgetManagerCompat;
import com.border.launcherfree.compat.LauncherActivityInfoCompat;
import com.border.launcherfree.compat.LauncherAppsCompat;
import com.border.launcherfree.compat.UserHandleCompat;
import com.border.launcherfree.compat.UserManagerCompat;
import com.border.launcherfree.config.FeatureFlags;
import com.border.launcherfree.config.ProviderConfig;
import com.border.launcherfree.dragndrop.DragController;
import com.border.launcherfree.dragndrop.DragLayer;
import com.border.launcherfree.dragndrop.DragOptions;
import com.border.launcherfree.dragndrop.DragView;
import com.border.launcherfree.dynamicui.ExtractedColors;
import com.border.launcherfree.folder.Folder;
import com.border.launcherfree.folder.FolderIcon;
import com.border.launcherfree.initialization.Initialization;
import com.border.launcherfree.keyboard.ViewGroupFocusHelper;
import com.border.launcherfree.logging.FileLog;
import com.border.launcherfree.logging.UserEventDispatcher;
import com.border.launcherfree.model.WidgetsModel;
import com.border.launcherfree.nano.LauncherLogProto;
import com.border.launcherfree.newsettings.NewSettingsActivity;
import com.border.launcherfree.pageindicators.PageIndicator;
import com.border.launcherfree.shortcuts.DeepShortcutManager;
import com.border.launcherfree.shortcuts.DeepShortcutsContainer;
import com.border.launcherfree.shortcuts.ShortcutKey;
import com.border.launcherfree.util.ActivityResultInfo;
import com.border.launcherfree.util.ComponentKey;
import com.border.launcherfree.util.ItemInfoMatcher;
import com.border.launcherfree.util.MultiHashMap;
import com.border.launcherfree.util.PackageManagerHelper;
import com.border.launcherfree.util.PendingRequestArgs;
import com.border.launcherfree.util.TestingUtils;
import com.border.launcherfree.util.Thunk;
import com.border.launcherfree.util.ViewOnDrawExecutor;
import com.border.launcherfree.widget.PendingAddWidgetInfo;
import com.border.launcherfree.widget.WidgetHostViewLoader;
import com.border.launcherfree.widget.WidgetsContainerView;
...
//        intent.setSourceBounds(getViewBounds(v));
        ...
        if (!mDragController.isDragging()) {
            ...
            if (itemUnderLongClick == null) {
                ...
                mWorkspace.performHapticFeedback(HapticFeedbackConstants.LONG_PRESS,
                        HapticFeedbackConstants.FLAG_IGNORE_VIEW_SETTING);
                if (mWorkspace.isInOverviewMode()) {
                    Log.e("Launcher", "isInOverViewMode");

                    mWorkspace.startReordering(v);
                } else {
                    Log.e("Launcher", "NotInOverViewMode");
    ...
    public Animator startWorkspaceStateChangeAnimation(Workspace.State toState,
        ...
        Log.e("Launcher", "startWorkspaceStateChangeAnimation");
