...
import com.border.launcherfree.util.CircleRevealOutlineProvider;
...
public class LauncherStateTransitionAnimation {
    ...
    private void startAnimationToWorkspaceFromAllApps(final Workspace.State fromWorkspaceState,
        ...
        Log.e("LauncherStateTransition", "startAnimationToWorkspaceFromAllApps");
    ...
    private void startAnimationToWorkspaceFromWidgets(final Workspace.State fromWorkspaceState,
            ...
            final Runnable onCompleteRunnable) {
        Log.e("LauncherStateTransition", "startAnimationToWorkspaceFromWidgets");
    ...
    private void startAnimationToNewWorkspaceState(final Workspace.State fromWorkspaceState,
        ...
        Log.e("LauncherStateTransition", "startAnimationToNewWorkspaceState");
    ...
    private void startAnimationToWorkspaceFromOverlay(
        ...
        Log.e("LauncherStateTransition", "startAnimationToWorkspaceFromOverlay");
        final AnimatorSet animation = LauncherAnimUtils.createAnimatorSet();
        final Resources res = mLauncher.getResources();
        final boolean material = Utilities.ATLEAST_LOLLIPOP;
        final int revealDuration = res.getInteger(R.integer.config_overlayRevealTime);
